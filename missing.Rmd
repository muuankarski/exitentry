...
opts_chunk$set(echo=TRUE,eval=TRUE, cache=TRUE)
```
...
```{rmissingeducationPY010N, fig.height=8, fig.width=10, cache=TRUE}
library(ggplot2)
library(reshape2)
library(VIM)
...
```{rmissingeducationPY010G, fig.height=8, fig.width=10, cache=TRUE}
library(ggplot2)
library(reshape2)
library(VIM)
...
```{rmissingeducationPL210A, fig.height=8, fig.width=10, cache=TRUE}
library(ggplot2)
library(reshape2)
library(VIM)
...
```{rmissingeducationPL210D, fig.height=8, fig.width=10, cache=TRUE}
library(ggplot2)
library(reshape2)
library(VIM)
...
```{rmissingeducationPL210L, fig.height=8, fig.width=10, cache=TRUE}
library(ggplot2)
library(reshape2)
library(VIM)
