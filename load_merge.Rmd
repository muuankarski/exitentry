...
hh_merge <- join(hh_reg,hh_data,by="HH_ID", type="full")
# merge personal datas
per_merge <- join(per_reg,per_data,by="PER_ID", type="full")
per_merge$HH_ID <- factor(paste(per_merge$RB010,per_merge$RB020,per_merge$PX030, sep="_"))
# merge household and personal into single data
#merge <- join(hh_merge,per_merge,by="HH_ID", type="full")
#--------------------------------------------------------------------#
