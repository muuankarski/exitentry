...
- all the age boxplots by wave and country have systematic error with roughly one year increase by year (as same individuals are in the data in several waves).
    - For such plot only the individual who "experience the event" should be selected for particular year
    - I will fix this from my work computer as my laptop does not have the RAM required
...
datEnterPensions <- merge(df.longx[,c("RB020","RB030","year","pensionEnter")],
                          dat.per, 
                          by=c("RB020","RB030"), 
                          all.x=TRUE)
datEnterPensions$time <- datEnterPensions$RB010 - datEnterPensions$year
```
